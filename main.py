...
if __name__ == '__main__':
    ...
    #     pass
    # else:
    graphs,labels,ALL2ID,fixed_node_num=prepare_dataset.create_graph_paths(os.path.join(args.datadir,'background'),os.path.join(args.datadir,'label_entity.pkl'))
